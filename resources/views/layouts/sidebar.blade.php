<a href="{{route('home')}}" class="text-white d-block px-3 rounded sidebar-menu {{ request()->routeIs('home') ? 'active' : '' }}">
...
{{-- @endcan --}}
@can('stock')
    <a href="{{ route('purchase.stock') }}" class="text-white d-block px-3 rounded sidebar-menu {{ request()->routeIs('purchase.stock') ? 'active' : '' }}">
