...
@section('content')
    ...
    <div class="px-3">
        <div class="d-flex justify-content-between align-items-center notPrint">
            @include('report.menu')
            <div class="d-flex">
                <a href="{{ route('report.userWise') }}?type=pdf" class="btn text-dark"><i
        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="printOnly">
                    ...
                    <i class="d-block text-center mb-3">(User wise Report)</i>
                </div>
                <x-table-component :headers="['S.N', 'User', 'Product Count', 'Total Price']">
